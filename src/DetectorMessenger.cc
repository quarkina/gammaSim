...
: G4UImessenger(), fDetector(Det),
  ...
  fBeamCmd(0)
{
  fTestDir = new G4UIdirectory("/detector/");
  fTestDir->SetGuidance(" Parameters for detector");

  fMatCmd = new G4UIcmdWithAString("/detector/TargetMat",this);
  ...
  fMat1Cmd = new G4UIcmdWithAString("/detector/WorldMat",this);
  ...
  fRCmd = new G4UIcmdWithADoubleAndUnit("/detector/TargetRadius",this);
  ...
  fLCmd = new G4UIcmdWithADoubleAndUnit("/detector/TargetLength",this);
  ...
  fBinCmd = new G4UIcmdWithAnInteger("/detector/NumberOfBinsE",this);
  ...
  fNOfAbsCmd = new G4UIcmdWithAnInteger("/detector/NumberDivZ",this);
  ...
  fEdepCmd = new G4UIcmdWithADoubleAndUnit("/detector/MaxEdep",this);
  ...
  fBeamCmd = new G4UIcmdWithABool("/detector/DefaultBeamPosition",this);
  fBeamCmd->SetGuidance("show inelastic and elastic cross sections");

  fVerbCmd = new G4UIcmdWithAnInteger("/detector/Verbose",this);
