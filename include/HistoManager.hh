...
public: 
  ...
  void AddLeakingParticle(const G4Track*);
    void AddParticleDetector(const G4Track*);
  void CountGammaParticle(const G4Track*);
  void AddEnergyDepositDetector(const G4Step*);
...
private:
  ...
  std::string fNeutronFile;
  std::string fGammaFile;
  std::string fDetectorFile;
  std::string fEnergyFile;
  std::string fPerfectDetFile;

  std::vector<G4int> fhitVec;
  std::vector<G4int> fparentVec;
  std::vector<G4double> fdepVec;
  std::vector<G4String> fnameVec;
  std::vector<G4String> forgVolVec;
  std::vector<G4double> fdetTimeVec; 
